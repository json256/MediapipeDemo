...
/**
 * Basic activity of MediaPipe basic app.
 */
public class BasicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        processor =
                new FrameProcessor(
                        ...
                        applicationInfo.metaData.getString("outputVideoStreamName")); //outputVideoStreamName
    ...
    protected Size cameraTargetResolution() {
        return null;// new Size(640, 480); // No preference and let the camera (helper) decide.
    }
